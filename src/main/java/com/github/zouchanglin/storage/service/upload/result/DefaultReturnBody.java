 ...
 */
@Data
public class DefaultReturnBody implements ReturnBody{
    /**
     * 存储的文件名
     */
    private String key;
     ...
     */
    @Override
    public String getReturnBodyJson(){
        return JSON.toJSONString(new DefaultReturnBody()).replace("0", "$(fsize)");
    }
}
